...
//let datos = JSON.parse(localStorage.getItem(guardar))
...
//}
   ...
   /*
    ...
    baseDatos[nuevoElemento.monto] = {...nuevoElemento}
}
//const nCantidad = Object.values(baseDatos).reduce((acc, {monto}) => acc + monto  ,0)
    //console.log(nCantidad)
    const pintarTotal = () => {
        Object.values(baseDatos).forEach(nuevoElemento =>{
